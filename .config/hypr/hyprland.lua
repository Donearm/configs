...
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("hyprctl switchxkblayout at-translated-set-2-keyboard next"))
...
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 4%-"), { locked = true })
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 4%+"), { locked = true })
